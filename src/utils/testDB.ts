...
// import { badCommentsPrompt } from "../networks/ai/prompt.js";
...
// const prompts = [codeQualityPrompt, badCommentsPrompt];
...
// if (commitSha) storeReview(review, MODEL, commitSha, prompts);
